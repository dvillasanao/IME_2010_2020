...
Aquí se define un vector llamado `tablas` que contiene los años `2010`, `2015` y `2020` como cadenas de texto. Este vector se utilizará para iterar y cargar las bases de datos correspondientes a esos años. 
...
- Renombrado de la columna: `rename("ANIO" = "AÑO")` cambia el nombre de la columna AÑO a `ANIO`.   
