               ...
               geom_line(aes(x = seq(1:(nrow(get(paste0("DP2_",tablas[i]))) - 4)), y = CV)) +
                geom_text(data = min.strata[[i]], aes(label = paste0("CV = ", round(CV, 4)), x = 5, y = CV),  
                  ...
                  geom_hline(data = min.strata[[i]], aes(yintercept = CV), color = "red") +
                   theme_minimal() + 
                    theme(title = element_text(family = "Montserrat Medium"), 
                          plot.title = element_text(size = 22, family = "Montserrat Medium"),
                          plot.subtitle = element_text(size = 20, family = "Montserrat Medium"),
                          axis.text = element_text(size = 14, family = "Montserrat Medium"),
                          axis.title = element_text(size = 18, family = "Montserrat Medium")) + 
